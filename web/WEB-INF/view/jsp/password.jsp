...
.title{background-color:#48a4f1;color:#fff;margin:0 0 40px 0;}
.title,
...
.box .vbox .input:focus{border-color:#48a4f1;}
...
.box .vbox span {border-radius:6px 0 0 6px;vertical-align:middle;height:48px;line-height:48px;background-color:#48a4f1;border:#48a4f1 1px solid;font-size:24px;margin:0;padding:0 20px;display:inline-block;color:#fff;}
.box .vbox img{width:120px;height:46px;border:none;cursor:pointer;vertical-align:middle;}
.box .button{background-color:#48a4f1;color:#fff;width:280px;height:50px;line-height:50px;cursor:pointer;border:none;border-radius:6px;-webkit-appearance:none;}
...
.box .link a:active,
.box .link label,
.box .link b{color:#48a4f1;font-size:12px;text-decoration:none;outline:none;}
...
.cp a:link,
.cp a:visited,
.cp a:active{font-size:12px;font-weight:normal;font-family:arial;color:#48a4f1;text-decoration:underline;outline:none;}
</style>
<style type="text/css">
/*
...
<body>
<div class="bg"></div>
<div class="title">&nbsp;广州市保税物流业务管理系统</div>
<div class="view">
